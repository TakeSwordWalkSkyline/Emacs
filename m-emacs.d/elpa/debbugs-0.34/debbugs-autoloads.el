...
This function assumes the variable `user-mail-address' is defined." t nil)
...
;;;***

;;;### (autoloads nil "debbugs-guix" "debbugs-guix.el" (0 0 0 0))
;;; Generated autoloads from debbugs-guix.el

(autoload 'debbugs-gnu-guix-search "debbugs-guix" "\
Search for open guix bugs and patches." t nil)

(autoload 'debbugs-org-guix-search "debbugs-guix" "\
Search for open guix bugs and patches and display the results in an org buffer." t nil)
